...
public class SearchResult {
    ...
    public static int getProductPrice(int index) {
        return Integer.parseInt(SearchResult.ProductPrice.get(index).getText().replaceAll("\\D+", ""));
    }

    public static int getTitleTotalProducts() {
        return Integer.parseInt(SearchResult.titleTotalProducts.getText().replaceAll("\\D+", ""));
    }
